...
public class CarController {
    ...
    @Autowired
    public CarController(CarService clientService) {
    ...
    ClientService. Реализацию данного сервиса мы пометили аннотацией @Service ранее, и теперь спринг сможет передать экземпляр
